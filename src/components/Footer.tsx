        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400">
              基于Python的数据分析在线教育平台，为商务数据分析与应用专业的学生提供完整的学习体系。
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/courses" className="text-gray-400 hover:text-white">课程</Link></li>
              <li><Link to="/dashboard" className="text-gray-400 hover:text-white">仪表板</Link></li>
              <li><Link to="/achievements" className="text-gray-400 hover:text-white">成就</Link></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">订阅我们的通讯，获取最新课程和资源。</p>
            <div className="flex">
              <input 
                type="email" 
                placeholder="您的邮箱" 
                className="px-4 py-2 rounded-l-md focus:outline-none text-gray-800 flex-grow"
              />
